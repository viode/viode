...
RSpec.feature "Ask specific user", type: :feature do
  ...
  scenario "Bob asks Ted a question from the new question page" do
    ...
    select ted.username, from: 'question_intended_respondent'
    ...
    expect(Question.last.intended_respondent).to eql(ted.id)
  end
  ...
  scenario "Bob clicks 'Ask this user' on Ted's profile" do 
    ...
    expect(page).to have_select('question_intended_respondent', selected: ted.username)
  end
end
